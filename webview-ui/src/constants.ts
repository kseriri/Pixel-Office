...
// Room name labels (drawn on the canvas at the top of each room)
export const ROOM_LABEL_TEXT_COLOR = '#ffffff';
export const ROOM_LABEL_BG_COLOR = 'rgba(20, 16, 25, 0.6)';
export const ROOM_LABEL_FONT = "'FS Pixel Sans', monospace";
export const ROOM_LABEL_BORDER_COLOR = '#ffd88a'; // nameplate frame (warm)
export const ROOM_LABEL_PLATE_BG = 'rgba(28, 22, 34, 0.85)'; // nameplate background

// Token-usage graph shown as a big wall screen in the monitor room.
export const MONITOR_SCREEN_BG_COLOR = '#0a1622'; // CRT dark navy
export const MONITOR_SCREEN_BORDER_COLOR = '#49e6c4'; // glowing cyan bezel
export const MONITOR_SCREEN_TRACK_COLOR = 'rgba(140, 245, 230, 0.14)'; // empty bar track
export const MONITOR_SCREEN_TITLE_COLOR = '#8ffbe6';
export const MONITOR_SCREEN_TEXT_COLOR = 'rgba(200, 255, 245, 0.92)';

// Model badges (small pill above each character showing its AI model)
export const MODEL_BADGE_TEXT_COLOR = '#ffffff';
export const MODEL_BADGE_FABLE_COLOR = '#d9a521'; // divine gold
export const MODEL_BADGE_OPUS_COLOR = '#7a5cff'; // purple
export const MODEL_BADGE_SONNET_COLOR = '#2a7fd4'; // blue
export const MODEL_BADGE_HAIKU_COLOR = '#2ba36b'; // green
export const MODEL_BADGE_GPT_COLOR = '#10a37f'; // OpenAI / Codex teal
export const MODEL_BADGE_DEFAULT_COLOR = '#555a66'; // slate
export const MODEL_HALO_COLOR = '#ffe066'; // fable halo (gold)
export const MODEL_WING_COLOR = '#fff6d6'; // fable wings (soft cream)
export const MODEL_WING_EDGE_COLOR = '#e8c24a'; // fable wing edge (gold)
export const MODEL_BADGE_STATS_COLOR = 'rgba(255,255,255,0.82)'; // token/cost line

// Utilization bar (a thin stacked bar under each model badge): active / waiting / idle.
export const UTIL_BAR_ACTIVE_COLOR = '#39c07a'; // working (green)
export const UTIL_BAR_WAITING_COLOR = '#e0a52a'; // waiting on user / permission (amber)
export const UTIL_BAR_IDLE_COLOR = 'rgba(255,255,255,0.16)'; // idle / resting (faint track)
...
export const MODEL_PRICING: Record<string, { in: number; out: number }> = {
  ...
  sonnet: { in: 3, out: 15 },
  haiku: { in: 1, out: 5 },
  gpt: { in: 1.25, out: 10 }, // OpenAI GPT/Codex (approximate)
  default: { in: 3, out: 15 },
};
// Cache token pricing multipliers relative to the model's input rate.
export const CACHE_READ_PRICE_MULT = 0.1; // cache reads ~10% of input
export const CACHE_WRITE_PRICE_MULT = 1.25; // 5-minute cache writes ~125% of input
