...
export function updateCharacter(
  ...
  // Accumulate utilization time by current status (drives the badge's usage bar).
  if (ch.isActive) ch.activeSec += dt;
  else if (ch.bubbleType === 'permission' || ch.waitingAwaitingInput) ch.waitingSec += dt;
  else ch.idleSec += dt;
